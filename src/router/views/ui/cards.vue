    ...
    <div class="row">
      <div class="col-md-4">
        <b-card>
          ...
          <h6 slot="header" class="mb-0">Featured</h6>
      ...
      <div class="col-md-4">
        <b-card header="Featured" footer="2 days ago">
          <b-card-text>With supporting text below as a natural lead-in to additional content. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</b-card-text>
        </b-card>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-md-4">
        <b-card bg-variant="secondary" text-variant="white">
          ...
          <b-card-text>With supporting text below as a natural lead-in to additional content.</b-card-text>
          <b-button href="#" variant="light" size="sm">Button</b-button>
        </b-card>
      </div>
      <div class="col-md-4">
