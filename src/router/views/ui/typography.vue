    ...
    <div class="row">
      <div class="col-12">
        <div class="card-box">
          ...
          <p
            class="sub-header"
          >Traditional heading elements are designed to work best in the meat of your page content. When you need a heading to stand out, consider using a display heading—a larger, slightly more opinionated heading style.</p>
        ...
        <div class="card-box">
          <div class="row">
            <div class="col-xl-6">
              ...
              <p
                class="text-muted m-b-15 m-t-20"
              >Use text utilities as needed to change the alignment of your blockquote.</p>
