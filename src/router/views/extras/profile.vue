...
import { inboxData } from './dataProfile'
...
export default {
  ...
  components: { VuePerfectScrollbar, Layout, PageHeader },
  data() {
    return {
      inboxData: inboxData,
      title: 'Profile',
    ...
    <div class="row">
      <div class="col-lg-4 col-xl-4">
        ...
        <div class="card-box">
          ...
          <VuePerfectScrollbar>
            <div class="inbox-widget" style="max-height: 404px;">
      ...
      <div class="col-lg-8 col-xl-8">
        <div class="card-box">
          <b-tabs content-class="mt-1" pills justified class="navtab-bg">
                  ...
                  <table class="table table-borderless mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>07/05/2018</td>
                        <td>
                          <span class="badge badge-blue">Work in Progress</span>
                        </td>
                ...
                <div class="border border-light p-2 mb-3">
                  ...
                  <div class="mt-2">
                    <a href="javascript: void(0);" class="btn btn-sm btn-link text-danger">
                      <i class="mdi mdi-heart"></i> Like (28)
                    </a>
                    <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted">
                      <i class="mdi mdi-share-variant"></i> Share
                    </a>
