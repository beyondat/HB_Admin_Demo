...
export default {
  ...
  data() {
    return {
      ...
      perPage: 10,
      fields: [
        { name: '__slot:customer', title: 'Customer', sortField: 'name' },
        'phone',
            ...
            <div class="row mb-2">
              <div class="col-sm-4">
                <a href="javascript: void(0);" class="btn btn-danger">
                  <i class="mdi mdi-plus-circle mr-1"></i> Add Customers
                </a>
              </div>
              <div class="col-sm-8">
              ...
              >
                <template slot="status" slot-scope="props">
                  <span
                    class="badge"
                    :class="{
                      'bg-soft-success text-success': props.rowData.status === 'Active',
                      'bg-soft-danger text-danger': props.rowData.status === 'Blocked' }"
                  >{{ props.rowData.status }}</span>
                </template>
                <template slot="customer" slot-scope="prop">
                  <img
