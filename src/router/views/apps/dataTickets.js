...
const tableData = [
    {
        id: '#1020',
        requestuser: require('@assets/images/users/user-9.jpg'),
        name: 'Erwin E. Brown',
        subject: 'A new rating has been received',
        assignuser: require('@assets/images/users/user-1.jpg'),
        priority: 'Medium',
        status: 'Closed',
    ...
    {
        id: '#1254',
        requestuser: require('@assets/images/users/user-8.jpg'),
        name: 'Margeret V. Ligon',
        subject: 'Your application has been received!',
        assignuser: require('@assets/images/users/user-10.jpg'),
        priority: 'High',
        status: 'Closed',
    ...
    {
        id: '#1256',
        requestuser: require('@assets/images/users/user-2.jpg'),
    ...
    {
        id: '#1352',
        requestuser: require('@assets/images/users/user-5.jpg'),
        name: 'Karen R. Doyle',
        subject: 'Question regarding your Bootstrap Theme',
        assignuser: require('@assets/images/users/user-8.jpg'),
        priority: 'High',
        status: 'Open',
        createddate: '01/04/2017',
        duedate: '21/05/2017'
    ...
    {
        id: '#2542',
        requestuser: require('@assets/images/users/user-3.jpg'),
        name: 'Jose D. Delacruz',
        subject: 'New submission on your website',
        assignuser: require('@assets/images/users/user-9.jpg'),
        priority: 'Medium',
        status: 'Closed',
    ...
    },
    {
        ...
        assignuser: require('@assets/images/users/user-2.jpg'),
        priority: 'Low',
        status: 'Open',
        createddate: '01/04/2017',
        duedate: '21/05/2017'
    ...
    {
        id: '#3653',
        requestuser: require('@assets/images/users/user-4.jpg'),
        name: 'Luke J. Sain',
    ...
    {
        id: '#9501',
        requestuser: require('@assets/images/users/user-10.jpg'),
        name: 'Amy R. Barnaby',
        subject: 'Homeworth for your property increased',
        assignuser: require('@assets/images/users/user-3.jpg'),
        priority: 'Low',
        status: 'Open',
        createddate: '01/04/2017',
        duedate: '21/05/2017'
