        ...
        items: [
            {
                ...
                date: 'Jan 16, 2019',
                task: 'Medium',
                user: [require('@assets/images/users/user-1.jpg'), require('@assets/images/users/user-3.jpg')],
                groupId: 1
            },
            {
                id: 2,
                ...
                date: 'Jan 22, 2019',
                task: 'Low',
                user: [require('@assets/images/users/user-2.jpg')],
                groupId: 1
            },
            {
                id: 3,
                ...
                date: 'Feb 08, 2019',
                task: 'Low',
                user: [require('@assets/images/users/user-5.jpg')],
                groupId: 1
            },
            {
                id: 4,
                ...
                date: 'Feb 12, 2019',
                task: 'High',
                user: [require('@assets/images/users/user-6.jpg'), require('@assets/images/users/user-7.jpg')],
                groupId: 1
            },
        ]
    },
        ...
        items: [
            {
                ...
                date: 'Feb 12, 2019',
                task: 'Low',
                user: [require('@assets/images/users/user-6.jpg')],
                groupId: 2
            },
            {
                id: 6,
                ...
                date: 'Jan 31, 2019',
                task: 'Low',
                user: [require('@assets/images/users/user-8.jpg'), require('@assets/images/users/user-4.jpg')],
                groupId: 2
            },
            {
                id: 7,
                ...
                date: 'Mar 27, 2019',
                task: 'High',
                user: [require('@assets/images/users/user-9.jpg')],
                groupId: 2
            },
        ]
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                date: 'Apr 19, 2019',
                task: 'Low',
                user: [require('@assets/images/users/user-5.jpg'), require('@assets/images/users/user-8.jpg')],
                groupId: 3
            },
            {
                id: 11,
                ...
                date: 'Apr 27, 2019',
                task: 'Low',
                user: [require('@assets/images/users/user-4.jpg')],
                groupId: 3
            }
        ]
    }
